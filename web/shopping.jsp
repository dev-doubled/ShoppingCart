                                ...
                                <form action="MainController" method="POST" id="form">
                                    <div class="phone">
                                        ...
                                        <div class="decs">
                                            ...
                                            <span class="names">
                                                <input title="phoneName" id="name" type="text" name="phoneName" value="<c:out value='${phone.phoneName}'/>" readonly=""/>
                                            </span>
                                            <span class="prices">
                                                <input title="price" id="price" type="text" name="phonePrice" value="<c:out value='${phone.phonePrice} $'/>" readonly=""/>
                                            </span>
                                        </div>
                                        <div class="buy">
                                            <div class="addToCart">
                                            ...
                                            <div class="quantitys">
                                                <select title="quantity" name="cmbQuantity" id="quantity">
                                                    <c:forEach var="i" begin="1" end="${phone.phoneQuantity}">
